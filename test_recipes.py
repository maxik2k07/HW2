...
def test_len():
    pizza = Recipe("Пицца",
                   [Ingredient("Мука", 100, "г"), Ingredient("Курица", 200, "г"), Ingredient("Томат", 300, "г")])
...
def test_add_recipe_works():
    ...
    first_list.add_recipe(
        Recipe("Пицца", [Ingredient("Мука", 100, "г"), Ingredient("Курица", 200, "г"), Ingredient("Томат", 300, "г")]),
        3.0)
...
def test_add_recipe_error():
    first_list = ShoppingList()
    with pytest.raises(ValueError):
        first_list.add_recipe(Recipe("Пицца", [Ingredient("Мука", 100, "г"), Ingredient("Курица", 200, "г"),
                                               Ingredient("Томат", 300, "г")]), -666.0)
